<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="Função" prop="funcao" sortable="custom" align="center" width="100">
        <template slot-scope="scope">
          <span>{{ scope.row.funcao | capitalize }}</span>
        </template>
      </el-table-column>
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px" style="_width: 400px; margin:0 50px 0 50px;">
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            <el-form-item label="Função" prop="funcao">
              <el-input v-model="temp.funcao" />
            </el-form-item>
...
<script>
import { fetchList, create, update, deleteItem } from '@/api/funcionarios'
